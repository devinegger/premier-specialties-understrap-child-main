	...
	*/
	  ...
	  $(document).ready(function ($) {
	    $('.product-info-tab').click(function (e) {
	      ...
	      if (clickedLink !== activeLink) {
	        ...
	        $('.group-' + parentGroupNumber + ' .image-' + activeLink).toggleClass('d-none'); // swap content

	        $('.group-' + parentGroupNumber + ' .content-' + clickedLink).toggleClass('d-none');
	        $('.group-' + parentGroupNumber + ' .content-' + activeLink).toggleClass('d-none'); // add/remove active class
	...
	(function ($) {
	  ...
	  function animateObject() {
	    ...
	    var object = $('.fadeup-effect'); //* Loop through each object in the array
