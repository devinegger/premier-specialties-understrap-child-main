...
foreach($product_items as $product_item) : 
    ...
    $product_image = wp_get_attachment_image( $product_image_ID, array(260,180), FALSE, array('class'=>'') ); // not sure how to grab the product url and alt from here... 
...
?>
    <div class="row bg-light mb-2 p-2 product-tile">
        <div class="col">
            <div class="row">
                <div class="col-md-3 px-0 product-image">
                    <?= $product_image ?>
                </div>
